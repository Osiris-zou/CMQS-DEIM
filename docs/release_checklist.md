...
- [x] Confirm `query_select_cost_mode: sum` in main experiments.
...
- [x] Create tag `v1.0.0` and a GitHub Release.
- [x] Upload the four exact assets listed in `release_assets/README.md`.
- [x] Confirm the README checkpoint and log links work.
