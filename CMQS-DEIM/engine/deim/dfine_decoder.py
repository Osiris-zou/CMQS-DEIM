...
class DFINETransformer(nn.Module):
    ...
    def __init__(self,
                 ...
                 query_select_gt_stop_epoch=5,
                 query_select_cost_mode='decomposed',
    ...
    def _select_topk(self,
                     ...
                     topk: int,
                     targets=None):
        if self.query_select_method in ('default', 'one2many', 'agnostic'):
            ...
            _, topk_ind = torch.topk(select_score, topk, dim=-1)
        else:
    ...
    def forward(self, feats, targets=None, epoch=None):
        self._current_epoch = 0 if epoch is None else epoch
